...
/** 
  ...
  *   
  * @example
  * [df_countdown datetime="yyyy/mm/dd hh:mm:ss" tick_col="" tick_size="" tick_style="" tick_sep_col="" tick_sep_style="" timer_bg_color=""] 
**/


function df_countdown_sc($atts){
	wp_enqueue_script( 'df-countdown' );
	wp_enqueue_script( 'df-count-timer' );

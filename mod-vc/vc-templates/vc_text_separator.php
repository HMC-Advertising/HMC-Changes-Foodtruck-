...
$inline_css = ( 'custom' == $color && $accent_color!='') ? 'style="'.vc_get_css_color('border-color', $accent_color).' border-width:'.$border_size.'; height: '.$height.';"' : 
...
?>
<div class="<?php echo esc_attr(trim($css_class)); ?>" style="padding: <?php echo $padding ?>;">

...
wp_enqueue_script('df-pie-chart');
if ($style_pie == 'thin') {
    $style_pie = 'pie-thin';
} else if ($style_pie == 'normal') {
    $style_pie = 'pie-normal';
} else if ($style_pie == 'thick') {
    $style_pie = 'pie-thick';
}
...
$output = "\n\t".'<div class= "'.$css_class.' '.$style_pie.'" data-pie-class="'.$style_pie.'" data-pie-value="'.$value.'" data-pie-label-value="'.$label_value.'" data-pie-units="'.$units.'" data-pie-color="'.htmlspecialchars($color).'">';
